...
insert into restaurante (id,nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, endereco_cidade_id, endereco_cep, endereco_complemento, endereco_logradouro, endereco_numero, endereco_bairro ) values (1, 'Tailandesa', 10.50, 1, current_timestamp, current_timestamp, 1, '72017-221', 'Chacará 25', 'Quadra', '34', 'Taguatinga');
...
insert into restaurante (id,nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao) values (3, 'Tuk Tuk Comida Indiana', 0, 3, current_timestamp, current_timestamp);
...
insert into restaurante (id,nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao) values (5, 'Lanchoneto do Tio Sam', 11, 4, current_timestamp, current_timestamp);
