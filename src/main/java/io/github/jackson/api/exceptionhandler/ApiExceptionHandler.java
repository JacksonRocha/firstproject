...
import io.github.jackson.core.validation.ValidacaoException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        return handlerValidationInternal(ex, ex.getBindingResult(), headers, status, request);
    }

    @Override
    protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex,
                                     HttpHeaders headers, HttpStatusCode statuts, WebRequest request) {

        ProblemType problemType = ProblemType.RECURSO_NAO_ENCONTRADA;
        String detail  = String.format("O recurso %s que você tentou acessar, é inexistente.",
                ex.getRequestURL());

        Problem problem = createProblemBuilder((HttpStatus) statuts, problemType, detail)
                .userMessage(detail)
                .build();

        return handleExceptionInternal(ex, problem, headers, statuts, request);
    }
    @Override
    ...
    public ResponseEntity<Object> handleValidacaoException(ValidacaoException ex, WebRequest request) {
        return handleExceptionInternal(ex, ex.getBindingResult(), new HttpHeaders(),
